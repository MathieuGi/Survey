...
insert into questions value(1, "Qui es-tu ?", 1, 0, 0, 0);
insert into questions value(2, "Comment t'appelles tu ?", 1, 0, 0, 0);
insert into questions value(3, "Es-tu un homme ou une femme ?", 1, 0, 0, 0);
insert into questions value(4, "Aimes-tu lire ?", 1, 0, 0, 0);
insert into questions value(5, "Qui est Morgan Freeman ?", 1, 0, 0, 0);
